...
export const journeyPhases: JourneyPhase[] = [
  ...
  },
  {
    ...
    periodLabel: "Live in Salman OS",
    role: "AI Automation · Live System",
    summary:
      "Active autonomous operations — Hermes is running live inside Salman OS as an AI operations agent monitoring websites, repositories, operational webhooks, approvals and system status.",
    skills: [
      "Autonomous agent architecture",
      "Real-time system & repo telemetry",
      "Operational webhook pipelines",
      "Approval & integration workflows",
    ],
    tools: ["Salman OS", "AI APIs", "Supabase", "Google Sheets automation", "Marketplace APIs"],
    relatedProjects: [],
    details: [
      "Hermes is deployed and running live as an autonomous operations daemon inside Salman OS.",
...
export const journeyHomePreview: {
  ...
  },
  {
    ...
    desc: "AI-assisted websites, platforms and the Hermes AI Agent — live in Salman OS.",
    icon: "cpu",
